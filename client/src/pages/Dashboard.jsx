  ...
  return (
    ...
    <div className="flex flex-row justify-center w-full mt-[40px] max-w-[1269px]">
      ...
      <div className="flex flex-row justify-start w-full gap-[43px]">
        ...
        <div className="flex flex-col items-center justify-start w-full p-[45px] border-indigo-900 border border-solid bg-gray-100 rounded-[36px]">
        <div className="flex flex-col items-center justify-start w-[88%] mt-[18px]">
           <img src={profileImage} alt="Profile" className="h-[225px] w-[225px] ml-2.5 rounded-[50%]" />
       ...
       <div className="flex flex-col items-center justify-start w-full mt-[72px] ">
          ...
          <div className="flex flex-row justify-center items-center w-full gap-[17px] p-[30px] mb-7 border-indigo-900 border border-solid rounded-[34px]">
            <h2 className= "w-[55%] ml-[21px]" >
              <span className="text-2xl font-normal text-indigo-900 font-helveticalight ">
                    Payments &<br />
              </span>
              <span className="text-indigo-900 uppercase text-[28px]">analytics</span>
         ...
         <div className="flex flex-col items-center justify-start w-[36%] gap-[30px]">
          <div className="flex flex-col items-center justify-center w-[99%] p-[31px] bg-indigo-900 rounded-[34px]">
          ...
          <div className="flex flex-col items-center justify-start w-full gap-[30px]">
                <div className="flex flex-row justify-end w-full p-[29px] border-indigo-900 border border-solid rounded-[34px]">
                  <div className="flex flex-col items-start justify-start w-[96%] mt-1 gap-2.5">
                    <h1 className="w-[58%] !leading-[39px]">
                        <span className="text-indigo-900 font-helveticalight text-[23px] font-normal">Past session</span>
                      <span className="text-xl font-normal text-indigo-900 font-helveticalight">
                        <br />
                      </span>
                      <span className="text-3xl font-bold text-indigo-900 uppercase">records </span>
                    </h1>
                      ...
                      <div className="flex flex-col w-[92%] mt-[3px] gap-3.5">
                       ...
                       <div className="flex flex-col items-center justify-start w-[2%]">
                        <div className="flex flex-row items-start justify-center w-full">
                          ...
                          <div className="h-[52px] w-1 mt-[7px] ml-[-4px] bg-indigo-900 rounded-[50%]" />
                        </div>
                      </div>
                 ...
                 <div className="flex flex-row justify-center w-full pt-[31px] px-[31px] border-indigo-900 border border-solid rounded-[34px]">
                 <div className="flex flex-row justify-start items-center w-[99%] mt-[5px] ml-[5px] gap-7">
                    ...
                    <h1 className="w-[62%] uppercase !leading-8">
                      <span className="text-3xl font-bold text-indigo-900">
                        ...
                        <span className="text-indigo-900 font-helveticalight capitalize text-[23px] font-normal">
                          (posted){" "}
                        </span>
                    </h1>
                  ...
                  <div className="flex flex-col items-center justify-start w-[2%]">
                      <div className="flex flex-row items-start justify-center w-full">
                        ...
                        <div className="h-[11px] w-full mt-[38px] ml-[-4px] bg-indigo-900 rounded-[50%]" />
                      </div>
                    </div>
            ...
            <div className="flex flex-col items-center justify-start w-[28%] gap-[34px]">
              <div className="flex flex-col items-center justify-start w-full p-[31px] border-indigo-900 border border-solid rounded-[34px]">
                <div className="flex flex-row justify-start items-center w-[97%] mb-[11px] gap-[21px]">
                  <div className="flex flex-col items-center justify-start w-[92%]">
                    <h1 className="w-[97%] !leading-[35px]">
                       <span className="text-indigo-900 text-[26px] font-normal">Session </span> <br />
                      <span className="text-4xl font-bold text-indigo-900">Requested</span>
                      <span className="font-normal text-indigo-900"></span>
                    </h1>
                      ...
                      <div className="flex flex-col items-center justify-start w-full mt-[13px] gap-[17px]">
                        <div className="flex flex-row justify-center items-center w-[89%]">
                          <div className="flex flex-col items-start justify-start w-[52%] gap-px">
                            ...
                            <button className="flex justify-center items-center w-[242px] h-[19px] px-[35px] py-[3px] !text-white bg-indigo-900 rounded-[9px] text-xs hover:scale-110">Do the payment{" "}</button>
                    ...
                    <div className="flex flex-col items-center justify-start w-full pt-[31px] px-[31px] border-indigo-900 border border-solid rounded-[31px]">
                    ...
                    <div className="flex flex-col items-start justify-start w-[97%]">
                      <h1 className="w-[69%]">
                        <span className="text-indigo-900 font-helveticalight text-[38px] font-normal">
                          Question
                          <br />
                        </span>
                        <span className="text-indigo-900 uppercase text-[32px] font-bold">bank</span>
                        <span className="text-indigo-900"></span>
                      </h1>
                      <div className="flex flex-row justify-start mt-[18px] gap-[5px]">
                        ...
                        <button className="font-helvetica font-bold min-w-[53px] bg-indigo-900 rounded-[6px] text-sm hover:scale-110 px-[5px] py-[3px] ">   CSS</button>
